...
import com.jskako.bluetooth.domain.chat.BluetoothController
import com.jskako.bluetooth.domain.chat.BluetoothDeviceDomain
import com.jskako.bluetooth.domain.chat.ConnectionResult
...
class AndroidBluetoothController(
    ...
    override fun connectToDevice(deviceDomain: BluetoothDeviceDomain): Flow<ConnectionResult> {
        return flow {
            ...
            val bluetoothDevice = bluetoothAdapter?.getRemoteDevice(deviceDomain.address)
    ...
    companion object {
        const val SERVICE_UUID = "28c2g1pf-28f4-4950-a1g5-9539401f6h2d"
    }
}